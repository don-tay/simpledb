...
/**
 * StudentDB with additional index on 1. Hash idx on course(deptid) 2. Hash idx
 * on enroll(studentid)
 */
public class CreateStudentDB2 {
   ...
   public static void main(String[] args) {
      try {
         ...
         s = "create index cse_did_idx on course(deptid) using hash";
         numRecordsUpdated = planner.executeUpdate(s, tx);
         System.out.println("Hash index cse_did_idx created on course(deptid).");
         ...
         String[] sectvals = { "(13, 12, 'turing', 2018)", "(23, 12, 'turing', 2019)", "(33, 32, 'newton', 2019)",
               ...
               "(403, 352, 'Marie-françoise', 2018)", "(413, 362, 'Eloise', 2016)", "(423,372, 'Berengere', 2022)",
         ...
         s = "create index enroll_sid_idx on enroll(studentid) using hash";
         numRecordsUpdated = planner.executeUpdate(s, tx);
         System.out.println("Hash index enroll_sid_idx created on enroll(studentid).");
