...
import static simpledb.parse.Lexer.INDEX_TYPE_HASH;
...
public class IndexInfo {
    ...
    */
   public IndexInfo(String idxname, String fldname, String indextype, Schema tblSchema, Transaction tx, StatInfo si) {
    ...
    */
   public Index open() {
      if (indextype.equals(INDEX_TYPE_HASH)) {
