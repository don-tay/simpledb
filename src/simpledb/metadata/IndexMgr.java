...
class IndexMgr {
   ...
   /**
    * Create the index manager. This constructor is called during system startup.
   ...
   /**
    * Create an index of the specified type for the specified field. A unique ID is
    * assigned to this index, and its information is stored in the idxcat table.
    * 
